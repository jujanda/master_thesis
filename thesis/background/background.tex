...
% \end{figure}
  ...
  \begin{figure}[ht]
  	...
  	\figcaption{\textit{"Scope of the MPEG-DASH standard. The formats and functionalities of the red blocks are defined by the specification. The clients control heuristics and media players, which aren't within the standard's scope."} (sic) \cite{Soda11}}
