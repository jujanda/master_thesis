...
% !!!!!!!!!!!!!!!!
    pdfauthor={Peter Schartner},
% !!!!!!!!!!!!!!!!
% !!! ANPASSEN !!! Titel der PDF-Datei
% !!!!!!!!!!!!!!!!
    pdftitle={syssec Formatvorlage + Tipps für wissenschaftliche Arbeiten},
% !!!!!!!!!!!!!!!!
...
% !!!!!!!!!!!!!!!!
 ...
 \title{syssec Formatvorlage \\
        Tipps für wissenschaftliche Arbeiten}
 \author{\ph{Vorname} \ph{Nachname}}
 \advisor{Assoc.Prof.~Dr.~Peter~Schartner}
 \version{\ph{0.01 -- 0.99}}
...
% \university{\vspace*{-20mm}\hfill\includegraphics[width=0.35\textwidth]{Logos/TeWiLogoGreen}\vspace*{10mm}}
 ...
 \researchgroup{Forschungsgruppe Systemsicherheit}
