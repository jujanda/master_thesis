...
% !!!!!!!!!!!!!!!!
    pdfkeywords={syssec Formatvorlage Tipps Richtlinien syssec Seminararbeit Masterarbeit DiplomandInnen},
%
%   colorlinks,
    linkcolor=blue,
    urlcolor=blue,
...
\ifthenelse{\boolean{ZITAT}}{
  \begin{flushright}
    \textit{\ph{Zitat}, falls gewünscht\\
...
%Topic
%	NDNRTC
%		Introduction to NDNRTC
%		NDNRTC workflow/specifics
%		NDNRTC future work (arc)
%	ARC
%		ARC Fundamentals
%		ARC Specifics (Adaption logics)
%	Previous Attempts to Integrate ARC in NDNRTC
%Implementation
%	Running NDNRTC in Linux
%	NDNRTC Code Structure (Visualization tools/attempts)
%	Thread Switching Implementation
%	ARC Module Implementation
%		ARC on Producer vs Consumer
%		Selection/Integration of Adaption Logics
%	ARC Module Integration (where to best integrate the module)	 
%Evaluation
%	Theoretical Setup
%		Video Sources
%		Network shaping	
